	...
	2) Copy add-in dll and all dependency dlls files to one of following locations: 
		a) Anywhere, then *.addin file <Assembly> setting should be updated to the full path including the <AddInName>.dll
